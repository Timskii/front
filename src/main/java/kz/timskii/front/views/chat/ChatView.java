package kz.timskii.front.views.chat;
...
import kz.timskii.front.services.AuthenticationFacade;
import kz.timskii.front.services.UserService;
...
@PageTitle("Chat")
@Route("chat")
@Menu(order = 3, icon = LineAwesomeIconUrl.COMMENTS)
@PermitAll
public class ChatView extends HorizontalLayout {
    ...
    public ChatView(AuthenticationFacade authenticationFacade) {
        ...
        UserInfo userInfo = new UserInfo(UUID.randomUUID().toString(), authenticationFacade.getCurrentUsername());
